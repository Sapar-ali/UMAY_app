...
def generate_ai_content(category, trimester, count):
    """МОЩНЫЙ ИИ-генератор контента с длинными статьями и картинками"""
    
    # Богатые шаблоны для генерации длинных статей
    templates = {
        'sport': {
            'titles': [
                'Полное руководство по упражнениям для беременных в {trimester} триместре',
                'Безопасная гимнастика для будущих мам: комплекс упражнений',
                'Йога для беременных: {trimester} триместр - техники и позы',
                'Дыхательные упражнения для подготовки к родам',
                'Пилатес для беременных: укрепление мышц тазового дна',
                'Аквааэробика для беременных: безопасные упражнения в воде',
                'Прогулки и ходьба во время беременности: правильная техника',
                'Растяжка для беременных: гибкость и расслабление'
            ],
            'content': [
                '''# Полное руководство по упражнениям для беременных в {trimester} триместре
...
## 🏃‍♀️ Почему упражнения важны во время беременности?

Физическая активность во время беременности приносит множество преимуществ:

- **Улучшение кровообращения** - снижает риск отеков и варикозного расширения вен
- **Укрепление мышц** - особенно важны мышцы тазового дна и брюшного пресса
- **Контроль веса** - помогает поддерживать здоровый набор веса
- **Улучшение настроения** - физическая активность повышает уровень эндорфинов
- **Подготовка к родам** - укрепляет мышцы, участвующие в процессе родов
...
- Вдохните глубоко через нос, почувствуйте, как поднимается живот
...
- На вдохе прогните спину, подняв голову и копчик
...
2. **Не перегревайтесь** - занимайтесь в прохладном помещении
...
Помните, что каждая беременность уникальна. То, что подходит одной женщине, может не подойти другой. Всегда консультируйтесь с врачом и прислушивайтесь к своему организму.''',

                '''# Безопасная гимнастика для будущих мам: комплекс упражнений

Беременность - это не повод отказываться от физической активности. Напротив, правильные упражнения помогут вам чувствовать себя лучше, подготовиться к родам и быстрее восстановиться после них. В этой статье мы рассмотрим безопасный комплекс упражнений, специально разработанный для беременных женщин.

## 🏋️‍♀️ Основные принципы тренировок для беременных

### Безопасность превыше всего
- Всегда консультируйтесь с врачом перед началом тренировок
- Избегайте упражнений, которые могут привести к падению
- Не перегревайтесь и не переутомляйтесь
- Слушайте свое тело и прекращайте упражнения при дискомфорте

### Регулярность важнее интенсивности
- Лучше заниматься по 15-20 минут каждый день
...
**3. Наклоны головы**
- Медленно наклоняйте голову в стороны
- Задержитесь на 5 секунд в каждом положении
- Избегайте резких движений

### Основная часть (15-20 минут)

**1. Упражнения для тазового дна (упражнения Кегеля)**
...
- Медленно приседайте, держась за спинку
- Спина прямая, колени не выходят за носки
- Повторите 8-10 раз

**4. Упражнения для рук**
- Возьмите легкие гантели (1-2 кг) или бутылки с водой
...
- Расслабьтесь на 5-10 минут

## 🚨 Противопоказания к упражнениям

Не занимайтесь физическими упражнениями, если у вас:
...
### Одежда и обувь
- Носите удобную, не сковывающую движения одежду
- Обувь должна быть устойчивой и удобной
- Избегайте тесной одежды

### Время тренировок
- Лучшее время - утром или вечером
- Избегайте тренировок в жаркое время дня
- Не занимайтесь сразу после еды

### Питание и питье
- Пейте достаточно воды до, во время и после тренировки
- Не занимайтесь на голодный желудок
- Имейте легкий перекус за час до тренировки
...
- Продолжительность
- Упражнения, которые выполняли
- Самочувствие до и после
- Любые неприятные ощущения
...
Помните, что каждая беременность уникальна. То, что подходит одной женщине, может не подойти другой. Всегда консультируйтесь с врачом и прислушивайтесь к своему организму.'''
        ...
        'nutrition': {
            'titles': [
                'Полное руководство по питанию для беременных в {trimester} триместре',
                'Витамины и минералы: что нужно знать будущим мамам',
                'Рецепты здорового питания для беременных женщин',
                'Продукты, которые нужно исключить во время беременности',
                'Питьевой режим: сколько воды нужно пить беременным',
                'Питание при токсикозе: как справиться с тошнотой',
                'Вегетарианство и беременность: как правильно питаться',
                'Питание для набора здорового веса во время беременности'
            ],
            'content': [
                '''# Полное руководство по питанию для беременных в {trimester} триместре

Правильное питание во время беременности - это основа здоровья мамы и малыша. В {trimester} триместре ваш организм претерпевает значительные изменения, и потребности в питательных веществах меняются. В этой статье мы подробно рассмотрим, как правильно питаться в этот важный период.

## 🍎 Основные принципы питания для беременных

### Сбалансированность
Ваш рацион должен включать все необходимые питательные вещества:
- **Белки** - строительный материал для клеток малыша
- **Углеводы** - источник энергии
- **Жиры** - важны для развития мозга ребенка
- **Витамины и минералы** - для правильного развития всех систем

### Регулярность
- Ешьте 5-6 раз в день небольшими порциями
- Не пропускайте приемы пищи
- Имейте легкие перекусы между основными приемами
...
## 🥗 Рекомендуемые продукты для {trimester} триместра

### Белковые продукты
**Мясо и рыба:**
- Нежирная говядина, телятина, крольчатина
- Курица и индейка (грудка)
- Рыба: лосось, треска, минтай, хек
- Яйца (только термически обработанные)
...
### Продукты с высоким риском заражения
- Сырые морепродукты
- Непастеризованные соки
- Пророщенные семена
- Сырые овощи (если не уверены в чистоте)
...
### Фолиевая кислота
- **Зачем нужна:** Профилактика пороков развития нервной трубки
- **Где содержится:** Зеленые овощи, бобовые, орехи
- **Дополнительно:** Принимать по назначению врача

### Железо
- **Зачем нужно:** Профилактика анемии
- **Где содержится:** Красное мясо, печень, бобовые
- **Совет:** Употреблять с витамином C для лучшего усвоения

### Кальций
- **Зачем нужен:** Развитие костей и зубов ребенка
- **Где содержится:** Молочные продукты, зеленые овощи
- **Норма:** 1000-1300 мг в день

### Витамин D
- **Зачем нужен:** Усвоение кальция
- **Где содержится:** Жирная рыба, яичные желтки
- **Дополнительно:** Прогулки на солнце

## 🥤 Питьевой режим

### Сколько пить
- **Общая норма:** 2-2.5 литра в день
- **В жаркую погоду:** Увеличить на 0.5-1 литр
- **При токсикозе:** Пить маленькими глотками

### Что пить
- **Вода:** Лучший выбор
- **Травяные чаи:** Ромашка, мята, липа
...
1. **Планируйте меню заранее** - это поможет избежать вредных перекусов
2. **Готовьте дома** - так вы контролируете качество продуктов
3. **Носите с собой полезные перекусы** - орехи, фрукты, йогурт
4. **Ведите дневник питания** - это поможет отследить реакцию на продукты
5. **Не ешьте за двоих** - качество важнее количества
...
- Отсутствие аппетита более 2 дней
- Резкая потеря веса
- Аллергические реакции на продукты
- Боли в животе после еды

Помните, что правильное питание - это инвестиция в здоровье вашего малыша. Каждый прием пищи - это возможность дать ребенку все необходимое для правильного развития.''',

                '''# Витамины и минералы: что нужно знать будущим мамам

Во время беременности потребность в витаминах и минералах значительно возрастает. Эти вещества играют crucial роль в развитии малыша и поддержании здоровья мамы. В этой статье мы подробно рассмотрим, какие витамины и минералы особенно важны во время беременности.
...
**Суточная норма:** 400-800 мкг
**Особенности:** Начинать принимать за 3 месяца до зачатия
...
**Суточная норма:** 1.9 мг

## 🦴 Кальций и витамин D

### Кальций
**Роль в организме:**
- Развитие костей и зубов ребенка
- Поддержание плотности костей мамы
- Сокращение мышц
- Свертывание крови

**Где содержится:**
- Молочные продукты (молоко, творог, сыр)
- Зеленые овощи (капуста, брокколи)
- Кунжут, миндаль
- Сардины с костями
...
- Употреблять с витамином C
- Не пить чай/кофе сразу после еды
- Разделять прием с кальцием
...
### Как выбрать
- Специальные комплексы для беременных
- Содержание фолиевой кислоты не менее 400 мкг
- Железо в составе
- Витамин D
...
### Время приема
- **Утром:** Железо, витамин C
- **Днем:** Кальций, витамин D
- **Вечером:** Магний (если назначен)

### Совместимость
- **Хорошо сочетаются:** Железо + витамин C
- **Плохо сочетаются:** Кальций + железо
- **Принимать отдельно:** Кальций и железо с интервалом 2 часа

### Побочные эффекты
- **Тошнота:** Принимать во время еды
- **Запор:** Пить больше воды
- **Изжога:** Не принимать натощак
...
### Приоритет питания
- Натуральные продукты всегда лучше
- Добавки - дополнение к питанию
- Консультация с врачом обязательна

## 📊 Контроль уровня витаминов

### Анализы крови
- **Гемоглобин:** Каждый триместр
- **Ферритин:** При подозрении на анемию
- **Витамин D:** По назначению врача
- **Фолиевая кислота:** При планировании

### Симптомы гипервитаминоза
- **Витамин A:** Головная боль, тошнота
- **Витамин D:** Тошнота, рвота
- **Железо:** Запор, тошнота
...
1. **Ведите дневник питания** - отслеживайте, что едите
2. **Разнообразьте рацион** - разные продукты содержат разные витамины
3. **Готовьте правильно** - некоторые витамины разрушаются при термической обработке
4. **Храните продукты правильно** - свет и воздух разрушают витамины
5. **Консультируйтесь с врачом** - не назначайте себе витамины самостоятельно

Помните, что правильное питание и прием витаминов - это инвестиция в здоровье вашего малыша. Каждый день вы строите фундамент для его будущего здоровья и развития.'''
            ],
            'images': [
                'https://images.unsplash.com/photo-1490645935967-10de6ba170d8?w=800&h=600&fit=crop',
    ...
    for i in range(count):
        template = templates.get(category, templates['nutrition'])
        ...
        image_url = template['images'][i % len(template['images'])]
        ...
        new_content = MamaContent(
            ...
            author='ИИ-Помощник',
            image_url=image_url,
            is_published=True  # Автоматически публикуем
        )
